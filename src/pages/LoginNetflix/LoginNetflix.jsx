import './LoginNetflix.scss'
import {useState, useEffect} from 'react';
import {useNavigate} from 'react-router-dom';
import {useAuth} from "../../context/AuthContext.jsx";

export default function LoginNetflix() {
    ...
    const handleLogin = async () => {
        ...
        else console.error('Login fallido');
    };
        ...
        <div className='div-login'>
            ...
            <div className='div-info'>
                ...
                <input
                    ...
                    type='text'
                    placeholder='Correo o numero de móvil'
                ...
                />
                <button
                    className='div-info-button'
                    onClick={handleLogin}
                >
                    Iniciar sesión
                </button>
                <p>
                    ¿No tienes aún Netflix?
                </p>
            </div>
